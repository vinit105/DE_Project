        ...
        child: Column(
          ...
          children: [
            ListTile(
              ...
              subtitle: Text(_groupSelectedValue!,
            ...
            ListTile(
              leading:
                  Icon(Icons.dark_mode, size: 30, color: Colors.grey.shade800),
              title: const Text("Night mode",
                  style: TextStyle(color: Colors.black)),
              subtitle: Text("Very dim display(for dark rooms)",
                  style: TextStyle(color: Colors.grey.shade800)),
              trailing: Switch(
            ...
            ListTile(
              title: const Text('Privacy Policy',
                  style: TextStyle(color: Colors.black)),
              leading:
                  Icon(Icons.policy, size: 30, color: Colors.grey.shade800),
              onTap: () async {
